...
int main(int argc, const char * argv[]) {
   ...
   cout << "Is myVector empty (1: yes, 0: no): " << myVector.isEmpty() << endl;
   ...
   cout << "Last Element[" << lastElem << "]: " << myVector.get(lastElem) << endl;
